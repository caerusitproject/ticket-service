...
public class FileController {
  ...
  public ResponseEntity<ApiResponse<List<FileUploadResponse>>> uploadTicketDocument(
      @PathVariable String contextId, @RequestParam("files") List<MultipartFile> files) {
  ...
  public ResponseEntity<Resource> serveTicketDocument(
      @PathVariable Long ticketId, @PathVariable String fileName) throws IOException {
  ...
  public ResponseEntity<Void> deleteDraftFile(
      @PathVariable String contextId, @PathVariable String fileName) {
  ...
  public ResponseEntity<Void> deleteTicketFile(
      @PathVariable Long ticketId, @PathVariable String fileName) {
