...
public class SubcategoryController {
  ...
  @PostMapping
  public ResponseEntity<ApiResponse<Map<String, Long>>> createSubcategory(
      @PathVariable Long categoryId, @Valid @RequestBody SubcategoryDto subcategoryDto) {
    SubcategoryDto dtoWithCategory = subcategoryDto.toBuilder().categoryId(categoryId).build();
  ...
  public ResponseEntity<ApiResponse<PageResponse<SubcategoryDto>>> getAllSubcategories(
    ...
    return ResponseEntity.ok(
        ApiResponse.success(
            ...
            subcategoryService.getAllSubcategories(deleted, categoryId, search, pageable)));
  }

  @PatchMapping("/{id}")
  public ResponseEntity<ApiResponse<SubcategoryDto>> patchSubcategoryById(
      @PathVariable Long categoryId,
      @PathVariable Long id,
      @RequestBody SubcategoryDto subcategoryDto) {
    SubcategoryDto updatedSubcategory =
        subcategoryService.patchSubcategoryById(categoryId, id, subcategoryDto);
    return ResponseEntity.ok(
        ApiResponse.success("Subcategory updated successfully", updatedSubcategory));
  }
  ...
  public ResponseEntity<ApiResponse<SubcategoryDto>> getSubcategoryById(
    ...
    return ResponseEntity.ok(
        ApiResponse.success("Subcategory retrieved successfully", subcategoryDto));
  }
