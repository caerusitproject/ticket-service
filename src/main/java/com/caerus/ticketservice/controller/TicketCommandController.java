...
public class TicketCommandController {
  ...
  @PostMapping
  public ResponseEntity<ApiResponse<Map<String, Long>>> createTicket(
  ...
  @PutMapping("/{id}")
  public ResponseEntity<ApiResponse<UpdateTicketRequestDto>> updateTicket(
      @PathVariable Long id, @Valid @RequestBody UpdateTicketRequestDto updateTicketRequestDto) {
    UpdateTicketRequestDto updatedTicket =
        ticketCommandService.updateTicketById(id, updateTicketRequestDto);
    return ResponseEntity.status(HttpStatus.OK)
        .body(ApiResponse.success(TICKET_UPDATED_MSG, updatedTicket));
  }

  @PatchMapping("/{id}")
  public ResponseEntity<ApiResponse<UpdateTicketRequestDto>> patchTicket(
      @PathVariable Long id, @RequestBody UpdateTicketRequestDto updateTicketRequestDto) {
    UpdateTicketRequestDto updatedTicket =
        ticketCommandService.patchTicketById(id, updateTicketRequestDto);
    return ResponseEntity.status(HttpStatus.OK)
        .body(ApiResponse.success(TICKET_UPDATED_MSG, updatedTicket));
  }
